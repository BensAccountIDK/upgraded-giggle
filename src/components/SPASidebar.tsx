const navItems = [
  ...
  { icon: "description", label: "All Articles", active: false },
  ...
  { icon: "group", label: "Staff Management", active: false },
      ...
      <div className="flex flex-col h-full space-y-4 font-body text-sm">
        ...
        <div className="flex-1 flex flex-col px-6 space-y-6">
          ...
          <div className="pt-6 border-t border-white/10">
            <h4 className="text-[10px] font-black uppercase tracking-widest text-[#f8f4f2]/40 mb-3 px-3">Overview</h4>
            <div className="space-y-1">
              <a className="flex items-center justify-between p-3 rounded-lg hover:bg-white/10 transition-colors" href="#">
                <span className="text-xs font-medium text-[#f8f4f2]">Pending approvals</span>
                <span className="bg-[#f8f4f2] text-primary text-[9px] px-1.5 py-0.5 rounded-full font-bold">8</span>
              </a>
              <a className="flex items-center justify-between p-3 rounded-lg hover:bg-white/10 transition-colors" href="#">
                <span className="text-xs font-medium text-[#f8f4f2]">Staff activity</span>
                <span className="bg-white/20 text-[#f8f4f2] text-[9px] px-1.5 py-0.5 rounded-full font-bold">12</span>
              </a>
            </div>
          </div>
