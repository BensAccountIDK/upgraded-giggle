const navItems = [
  ...
  { icon: "description", label: "My Articles", active: false },
  { icon: "send", label: "Submissions", active: false },
  { icon: "rate_review", label: "My Reviews", active: false },
          ...
          <div className="pt-6 border-t border-white/10">
            ...
            <div className="space-y-1">
              <a className="flex items-center justify-between p-3 rounded-lg hover:bg-white/10 transition-colors" href="#">
                ...
                <span className="bg-[#f8f4f2] text-primary text-[9px] px-1.5 py-0.5 rounded-full font-bold">2</span>
              </a>
              <a className="flex items-center justify-between p-3 rounded-lg hover:bg-white/10 transition-colors" href="#">
                <span className="text-xs font-medium text-[#f8f4f2]">Pending submission</span>
                <span className="bg-white/20 text-[#f8f4f2] text-[9px] px-1.5 py-0.5 rounded-full font-bold">3</span>
              </a>
            </div>
          </div>
